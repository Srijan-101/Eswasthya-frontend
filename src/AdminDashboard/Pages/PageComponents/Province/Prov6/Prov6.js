                ...
                <div className='grid lg:grid-cols-2 sm:grid-cols-1 md:grid-cols-1'>
                    <div class="relative m-3">
                        <div className='grid grid-cols-2 gap-4 sm-grid-cols-2'>
                            ...
                            <button onClick={() => { ApplyClick(6) }} disabled={!optionControl.SecondOp} type="button" class=" h-[40px] mt-7 w-[100px] py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200">Apply</button>
                        </div>
                    </div>
                        ...
                        <div class="w-full h-[150px] max-w-sm p-5 bg-white border border-gray-200 rounded-lg shadow">
                            ...
                            <div className='grid grid-cols-1'>
                                <div class="flex col-span-2 flex-col pl-5 pb-5">
                                    <h5 class="mb-1 text-xl align-left font-bold text-gray-600">Province 6</h5>
                                    <h5 class="mb-1 lg:text-2xl sm:text-xl md:text-xl align-left font-bold text-gray-900">Karnali pradesh</h5>
                                </div>
                            </div>
                        </div>
